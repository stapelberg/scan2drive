...
// Generated by "go run gentmpl.go Index".
...
<script type="text/javascript" src="/static/scan2drive.js"></script>
...
<paper-card class="scan">
	<div class="scan-content">
		...
		<div class="card-actions">
			<paper-button><iron-icon src="/static/drive48.png"></iron-icon>view in drive</paper-button>
		</div>
	</div>
